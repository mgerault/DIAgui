...
* Rstudio version > 1.0
* Dependent packages:  
"shiny", "shinydashboard", "shinycssloaders", "shinyWidgets", "shinyFiles", "shinyjs", "data.table", "dplyr", "tidyr", "purrr", "openxlsx", "plotly", "ggplot2", "ggrepel", "ggpubr", "stringr", "Rcpp", "RcppEigen", "iq", "seqinr", "DT", "limma"
 
One package is not from CRAN and hence will not be installed when you will install mineCETSAapp package: "limma". For this package, you need to install it from BioConductor. For this, type this command in the R console :
